                    ...
                    <div className="lg:col-span-1 sm:col-span-3 justify-center" id="edit_summary_div">
                        <div className="py-1 bg-blue-500 rounded-3xl px-10 shadow-[1.0px_1.0px_2.0px_1.0px_rgba(0,0,0,0.58)]">
                            {this.props.repos.length > 0 && (
                                <h1 id="title_element"
                                    className="self-center text-center text-white text-xl text-center font-semibold font-mono mb-1 mt-3">
                            ...
                            {this.state.commits.length > 0 && (
                                <div className="bg-white px-3 rounded-3xl h-80 overflow-y-auto">
                                    {this.state.commits.map((commit) => {
                                        return (
                                            <div className="h-30 mb-2 m-2">
