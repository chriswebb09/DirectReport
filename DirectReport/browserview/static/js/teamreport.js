...
const TeamData = () => {
    ...
    return (
        <div>
            <h1 class="self-center text-center text-4xl text-indigo-800 tracking-wide text-center font-black mb-10 mt-10 mx-20 px-20">Generate Team Report From Metadata</h1>
            <div class="grid grid-cols-3 gap-10 mt-10 mb-20 mx-20">
                <div class="col-span-1 justify-center my-10" id="edit_summary_div">
                    <div class="shadow-lg py-1 border-4 bg-blue-500 rounded-2xl px-30 mb-10">
                        <form class="py-2" onSubmit={handleSubmit}>
                            <h1 class="self-center text-center text-white tracking-wide text-2xl text-center font-bold mb-4 mt-6">Enter Github Data</h1>
                            <div class="self-center mb-6 mt-5">
                                <div class="py-4 px-10 mx-0 min-w-full flex flex-col items-center">
                                    <textarea id="prompt_input" cols="30" rows="13" class="self-center border-4 border-white w-90 sm:w-90 text-base tracking-wide text-indigo-700 placeholder-white border rounded-2xl focus:shadow-outline" value={commentText}  onChange={e => setCommentText(e.target.value)} ></textarea>
                                </div>
                                <div class="px-10 mx-0 min-w-full flex flex-col items-center">
                                    <button id="submit_prompt_btn" class="shadow-md w-80 sm:w-90 tracking-wide bg-white hover:bg-blue-700 text-indigo-700 hover:text-white border-4 border-indigo-700 hover:border-gray-200 text-xl font-semibold py-4 px-10 rounded-lg mt-10"  type="submit">Generate</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div id="show_summmary_div" class="col-span-1 justify-center my-10">
                    <div class="shadow-lg py-3 bg-blue-500 rounded-2xl px-30 mb-10">
                        <h1 class="self-center text-center text-2xl tracking-wide text-white text-center font-bold mb-6 mt-10 mx-20 px-20">Summary</h1>
                        <div id="summary" class="px-2 mx-0 mb-8 mt-8">
                            {isOpened && (
                                <div id="summary-container" class="bg-white ml-3 mr-3 overflow-y-scroll h-90 rounded-2xl border-4 border-gray tracking-wide text-gray-500 md:text-gl dark:text-gray-400 mt-6 mb-14 px-1 py-4">
                                    <p id="show_summary" class="w-97 sm:w-97 overflow-y-auto break-words">
                                        { teamData["report"] !== undefined ?
                                            <div className="my-7 px-2 text-sm tracking-wide text-blue-700">{teamData["report"]["summary"]}</div>
                                            : null
                                        }
                                    </p>
                                    <div class="h-80">
                ...
                <div id="team_member_to_select" class="col-span-1 justify-center my-10">
                    <div class="shadow-lg py-1 border-4 bg-blue-500 rounded-2xl px-4 mb-9">
                        ...
                        {isOpened && (
                            <div className="content-center py-2 h-90 rounded-2xl ml-3 mb-12 border-4 bg-slate-100 mx-2 px-2">
                                <div className="items-center my-6 mx-2 px-2 select-none">
                                    {teamData["team"] &&
                                        teamData["team"].map(teammember =>
                                                ...
                                                <button class="bg-blue-600 py-1 px-3 pb-2 pt-2.5 mr-2 my-2 shadow-md no-underline rounded-full text-white font-sans border-2 border-gray font-medium text-sm btn-primary hover:text-white hover:bg-indigo-700 focus:outline-none active:shadow-none" onClick={openPopover}>{teammember.name}</button>
                                            // </form>
                                        )}
                                </div>
                            </div>
