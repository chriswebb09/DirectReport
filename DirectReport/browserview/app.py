...
def account_data():
    ...
    # ["name": String(current_user.username), "userid": current_user_id]
...
def report():
    ...
    client = GithubClient()
    print(client.get_pull_request_comments())
    # print(client.parse_git_shortlog(logitem))
    elements["shortlog"] = client.parse_git_shortlog(logitem)
    print(elements["shortlog"])
    # print(elements)
